  ...
  data: [
    {
      ...
      suggestion: 'ගෙදර',
      explanation: 'Letters appear scrambled. Common visual sequencing error in dyslexia.',
      confidence: 0.95,
      source: 'hybrid',
    },
    {
      ...
      suggestion: 'යනවා',
      explanation: 'Incomplete verb ending. Colloquial form used instead of written form.',
      confidence: 0.90,
      source: 'rule-based',
    },
  ],
